...
<form action="<?php echo base_url() ?>user/pelanggan/keranjang/konfirmasi" method="post">
        ...
        <tr class="techSpecRow">
          ...
          <tr class="techSpecRow">
            <td class="techSpecTD1">Batas Akhir Pembayaran</td>
            <td class="techSpecTD2">???
          </td>
        </tr>
          <tr class="techSpecRow">
            <td class="techSpecTD1">Bukti Pembayaran</td>
            <td class="techSpecTD2"> Tampilkan file bukti jika sudah upload, tampilkan form untu upoad jika belum
          </td>
        </tr>
          <tr class="techSpecRow">
            <td class="techSpecTD1">Status Pesanan</td>
            <td class="techSpecTD2"> <?php echo $status ?>
          </td>
        </tr>
