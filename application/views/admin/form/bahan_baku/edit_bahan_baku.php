 <div class="row">
    <div class="col-md-6">
      <div class="box">
        ...
        <div class="box-body">
          <form action="<?php echo base_url('user/admin/bahan_baku/simpanedit') ?>" method='post'  enctype="multipart/form-data">
            
            <div class="form-group">
              <label>Bahan Baku</label>
              <input type="hidden" name="id" class="form-control" required value="<?php echo $bahan_baku['id_bahan_baku'] ?>">
              <input type="hidden" name="filelama" class="form-control" required value="<?php echo $bahan_baku['gambar'] ?>">
              <input type="text" name="bahan_baku" class="form-control" required value="<?php echo $bahan_baku['nama_bahan_baku'] ?>">
            </div>
            ...
            <div class="form-group" id="f_warna">
              <label>Warna</label>
              <input class="form-control" name="warna" id="warna" value="<?php echo $bahan_baku['keterangan'] ?>">
            ...
            <script type="text/javascript">
              $('#untuk').change(function(){
                ...
                if (peruntukan=='Topping') {
                  ...
                  <option value="<?php echo $d['id_topping'] ?>" <?php if($d==$bahan_baku['id_topping']){echo "selected";} ?>><?php echo $d['nama_topping'] ?></option>
                <?php } ?>
                  `);
                }else{
                  $('#f_topping').hide();
